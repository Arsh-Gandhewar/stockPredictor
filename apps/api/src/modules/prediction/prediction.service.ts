...
export class QuantPredictionService implements OnModuleInit {
  ...
  private getSeedUniversePredictions(): StockPrediction[] {
    const rawSeeds = [
      { ticker: 'TCS.NS', name: 'Tata Consultancy Services Limited', sector: 'Technology', price: 2067.20, change: -19.80, changePct: -0.95, p5d: 0.78, p20d: 0.84, expRet: 0.032, stopLoss: 2010.00, target: 2180.00, rr: 2.8, vol: 0.015, decision: 'STRONG_BUY' as const, catalyst: 'Multi-quarter orderbook expansion with strong institutional accumulation.' },
      { ticker: 'INFY.NS', name: 'Infosys Limited', sector: 'Technology', price: 998.40, change: -16.10, changePct: -1.59, p5d: 0.73, p20d: 0.79, expRet: 0.028, stopLoss: 970.00, target: 1050.00, rr: 2.5, vol: 0.018, decision: 'BUY' as const, catalyst: 'Deal pipeline renewal, outperforming NIFTY IT benchmark with low volatility.' },
      { ticker: 'RELIANCE.NS', name: 'Reliance Industries Limited', sector: 'Energy', price: 1220.20, change: 1.00, changePct: 0.08, p5d: 0.71, p20d: 0.76, expRet: 0.024, stopLoss: 1185.00, target: 1280.00, rr: 2.2, vol: 0.016, decision: 'BUY' as const, catalyst: 'Refining margins recovery and retail expansion driving institutional block volume.' },
      { ticker: 'HDFCBANK.NS', name: 'HDFC Bank Limited', sector: 'Financial Services', price: 727.55, change: -1.35, changePct: -0.19, p5d: 0.68, p20d: 0.74, expRet: 0.021, stopLoss: 710.00, target: 765.00, rr: 2.1, vol: 0.014, decision: 'ACCUMULATE' as const, catalyst: 'Deposit growth acceleration narrowing credit-deposit ratio; consolidation at 200 EMA support.' },
      { ticker: 'LT.NS', name: 'Larsen & Toubro Limited', sector: 'Capital Goods', price: 3863.70, change: 5.30, changePct: 0.14, p5d: 0.74, p20d: 0.80, expRet: 0.031, stopLoss: 3750.00, target: 4050.00, rr: 2.6, vol: 0.019, decision: 'BUY' as const, catalyst: 'Domestic infrastructure execution surge with hydrocarbon international order wins.' },
      { ticker: 'TATAMOTORS.NS', name: 'Tata Motors Limited', sector: 'Automobile', price: 439.85, change: 2.70, changePct: 0.62, p5d: 0.79, p20d: 0.85, expRet: 0.078, stopLoss: 420.00, target: 475.00, rr: 3.4, vol: 0.038, decision: 'STRONG_BUY' as const, catalyst: 'JLR global EV margin expansion and commercial vehicle replacement cycle inflection.' },
      { ticker: 'BAJFINANCE.NS', name: 'Bajaj Finance Limited', sector: 'Financial Services', price: 988.30, change: 6.30, changePct: 0.64, p5d: 0.75, p20d: 0.81, expRet: 0.071, stopLoss: 950.00, target: 1060.00, rr: 2.9, vol: 0.032, decision: 'BUY' as const, catalyst: 'Strong customer acquisition momentum with omnichannel payments platform scaling.' },
      { ticker: 'BHARTIARTL.NS', name: 'Bharti Airtel Limited', sector: 'Telecommunication', price: 1797.80, change: 2.00, changePct: 0.11, p5d: 0.72, p20d: 0.78, expRet: 0.074, stopLoss: 1740.00, target: 1910.00, rr: 3.1, vol: 0.029, decision: 'BUY' as const, catalyst: 'ARPU expansion following tariff revisions and subscriber market share gains.' },
    ];
